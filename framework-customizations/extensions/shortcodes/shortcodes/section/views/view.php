...
?>
<section<?php echo esc_attr($custom_id) ?> class="fw-main-row<?php echo esc_attr($section_extra_classes) ?><?php echo $custom_class; ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
